...
// Twitch Webhook Subscription
exports.whStreamSub = async function() {
    // send subscription request
  // Subscription endpoint
  var endpoint = "https://api.twitch.tv/helix/webhooks/hub"
  var params = {
    method: "POST",
    headers: {
    ...
    body: JSON.stringify({
      "hub.callback": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6t3kcpESO20o70DS-6IXErCigX3V4eHPUsfYKshtNjzMIei5buQ&s",
      "hub.mode": "subscribe",
      "hub.topic": "https://api.twitch.tv/helix/streams?user_id=" + channelId,
      "hub.lease_seconds": 864000
      }),
  }
  var resp = await fetch(endpoint, params)
    .then(res => {
      if (res.status === 202) {
